...
class PageStudioServiceProvider extends ServiceProvider
{
    ...
    protected function registerBuiltinNodes(): void
    {
        $builtins = [
            ...
            Nodes\Builtin\SourceBoolNode::class,
            ...
            Nodes\Builtin\TransformCompareNode::class,
            Nodes\Builtin\TransformClampNode::class,
            Nodes\Builtin\TransformRoundNode::class,
            Nodes\Builtin\TransformBooleanNode::class,
            Nodes\Builtin\TransformMixNode::class,
            Nodes\Builtin\TransformSubstringNode::class,
            Nodes\Builtin\TransformMinMaxNode::class,
            ...
            Nodes\Builtin\ImageRadialGradientNode::class,
            Nodes\Builtin\ImageStripesNode::class,
            Nodes\Builtin\ImageBrickNode::class,
            Nodes\Builtin\ImageCheckerboardNode::class,
            Nodes\Builtin\ImageDotsNode::class,
            Nodes\Builtin\ImageWaveNode::class,
